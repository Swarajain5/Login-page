...
const Login = () => {
    ...
    const handleSubmission = () => {
        if (!valves.email || !valves.password) {
        ...
        signInWithEmailAndPassword(auth, valves.email, valves.password)
            .then((res) => {
                    ...
                    <div className='login_style col-sm-12'>
                        <div className="mb-3">
                            ...
                            <input
                                ...
                                onChange={(event) => setValves((prev) => ({ ...prev, email: event.target.value }))}
                        ...
                        <div className="mb-3">
                            ...
                            <input
                                ...
                                onChange={(event) => setValves((prev) => ({ ...prev, password: event.target.value }))}
                                id="exampleInputPassword1"
                            />
                        </div>
                        <div className='sumbit_style'>
                            <button type="button" onClick={handleSubmission} className="btn btn-primary button">Submit</button>
                        </div>
                        <br />
                        Already do not have an account? <Link to='/signup'>Sign-up</Link>
                    </div>
                </form>
            </div>
